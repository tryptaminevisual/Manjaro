...
dir_f = "/home/florens/Scripts/.Pentest/" + sel + "/bfile.txt"
print(50 * "-")
filename = '/home/florens/Scripts/.Pentest/' + sel + '/.tools.txt'
...
if sel in tools_s:
    ...
    in_f = "/home/florens/Scripts/.Pentest/" + sel + "/afile.txt"
    dir_c = "/usr/share/" + sel
    if sel2 == "1":
        with open(in_f) as f:
            if dir_c in f.read():
                ...
                f_d = "/home/florens/Scripts/.Pentest/" + sel + "/./run.sh"
